...
openssl x509 -req -in server.csr  -CA ../ca_certificates/ca.crt -CAkey ../ca_certificates/ca.key -CAcreateserial -out server.crt -days 36500 -extfile <(printf "subjectAltName=IP:$IP")
