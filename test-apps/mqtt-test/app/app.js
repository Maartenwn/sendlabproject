...
var KEY = fs.readFileSync('/root/mqtt-test/certs/client.key')
var CERT = fs.readFileSync('/root/mqtt-test/certs/client.crt')
var TRUSTED_CA_LIST = fs.readFileSync('/root/mqtt-test/certs/ca.crt')
